    ...
    return (
        <>
            <Modal open={open} onClose={handelClick}>
                ...
                <div>
                    <div className='text-sm my-1 mt-3'>Advert type</div>
                    <div className="flex">
                        <div className="flex">
